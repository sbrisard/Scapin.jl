...
``` 
u[1] = xi[1]*xi[2]*xi[3]*u[[2,2,2],1]+xi[1]*xi[2]*(1-xi[3])*u[[2,2,1],1]+xi[1]*(1-xi[2])*xi[3]*u[[2,1,2],1]+xi[1]*(1-xi[2])*(1-xi[3])*u[[2,1,1],1]+(1-xi[1])*xi[2]*xi[3]*u[[1,2,2],1]+(1-xi[1])*xi[2]*(1-xi[3])*u[[1,2,1],1]+(1-xi[1])*(1-xi[2])*xi[3]*u[[1,1,2],1]+(1-xi[1])*(1-xi[2])*(1-xi[3])*u[[1,1,1],1] 

u[2] = xi[1]*xi[2]*xi[3]*u[[2,2,2],2]+xi[1]*xi[2]*(1-xi[3])*u[[2,2,1],2]+xi[1]*(1-xi[2])*xi[3]*u[[2,1,2],2]+xi[1]*(1-xi[2])*(1-xi[3])*u[[2,1,1],2]+(1-xi[1])*xi[2]*xi[3]*u[[1,2,2],2]+(1-xi[1])*xi[2]*(1-xi[3])*u[[1,2,1],2]+(1-xi[1])*(1-xi[2])*xi[3]*u[[1,1,2],2]+(1-xi[1])*(1-xi[2])*(1-xi[3])*u[[1,1,1],2] 

u[3] = xi[1]*xi[2]*xi[3]*u[[2,2,2],3]+xi[1]*xi[2]*(1-xi[3])*u[[2,2,1],3]+xi[1]*(1-xi[2])*xi[3]*u[[2,1,2],3]+xi[1]*(1-xi[2])*(1-xi[3])*u[[2,1,1],3]+(1-xi[1])*xi[2]*xi[3]*u[[1,2,2],3]+(1-xi[1])*xi[2]*(1-xi[3])*u[[1,2,1],3]+(1-xi[1])*(1-xi[2])*xi[3]*u[[1,1,2],3]+(1-xi[1])*(1-xi[2])*(1-xi[3])*u[[1,1,1],3] 
